...
import za.co.system.provider.services.health.gateway.PatientCareApp;
import za.co.system.provider.services.health.gateway.config.TestSecurityConfiguration;
import io.github.jhipster.config.JHipsterProperties;
import za.co.system.provider.services.health.gateway.config.audit.AuditEventConverter;
import za.co.system.provider.services.health.gateway.domain.PersistentAuditEvent;
import za.co.system.provider.services.health.gateway.repository.PersistenceAuditEventRepository;
import za.co.system.provider.services.health.gateway.security.AuthoritiesConstants;

import za.co.system.provider.services.health.gateway.service.AuditEventService;
...
@SpringBootTest(classes = {PatientCareApp.class, TestSecurityConfiguration.class})
@Transactional
