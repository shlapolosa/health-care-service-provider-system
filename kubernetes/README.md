...
```
$ docker image tag patientcare shlapolosa/patientcare
$ docker push shlapolosa/patientcare
$ docker image tag referencedata shlapolosa/referencedata
$ docker push shlapolosa/referencedata
$ docker image tag referal shlapolosa/referal
$ docker push shlapolosa/referal
$ docker image tag schedule shlapolosa/schedule
$ docker push shlapolosa/schedule
$ docker image tag care shlapolosa/care
$ docker push shlapolosa/care
$ docker image tag verification shlapolosa/verification
$ docker push shlapolosa/verification
```
