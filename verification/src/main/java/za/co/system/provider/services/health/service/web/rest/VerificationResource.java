...
import za.co.system.provider.services.health.service.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link za.co.system.provider.services.health.service.domain.Verification}.
 */
@RestController
@RequestMapping("/api")
public class VerificationResource {
    ...
    private static final String ENTITY_NAME = "verificationVerification";
